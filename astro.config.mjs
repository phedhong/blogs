...
export default defineConfig({
  ...
  integrations: [AutoImport({
    imports: ["./src/components/astro/mdx/mdxComponents.ts", "./src/components/astro/mdx/Intro.astro", "./src/components/astro/mdx/Note.astro", {
      "astro-embed": ["YouTube"]
    }]
  }), mdx(), preact(), svelte(), tailwind(), ...customScripts, sitemap()],
  markdown: {
