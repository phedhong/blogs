<script lang="ts">
	...
	export let cssClass =
		'appearance-none rounded-md block w-full px-3 py-2 border border-black/20 placeholder-black/80 text-black focus:outline-none focus:z-10 sm:text-sm'
	...
	const cInput =
		'block py-1 pl-12 w-full text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer'
	const cLabel =
...
<div class={classesBase}>
	<input bind:value {...{ type }} {...$$restProps} {placeholder} {id} required class={classInput} />
