<script lang="ts">
	...
	const buttonVariants = {
		google:
			'disabled:opacity-50 disabled:pointer-events-none group relative w-full flex justify-center items-center py-2 px-4 border border-gray-300 text-sm font-medium rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500',
		outlined:
			'py-2 px-4 rounded-md border border-gray-300 text-black hover:bg-gray-50 transition duration-200 ease-in-out',
		ghost:
		...
		rounded:
			'rounded-full border border-black p-1.5 px-4 text-sm text-white hover:bg-black/80 transition duration-200 ease-in-out ',
		default:
			'flex justify-center items-center disabled:opacity-30 disabled:pointer-events-none py-2 px-4 rounded-md text-white hover:bg-black/80 focus:outline-none focus:ring-2 transition duration-200 ease-in-out'
	}
