...
-->
<script lang="ts">
	import { clickOutside, focusTrap, keyDown } from './actions'
...
<div class="relative">
	...
	{#if open}
		<div
			...
			tabindex="-1"
			class="absolute right-0 z-50 mt-2 w-56 rounded-md border border-gray-200 shadow-lg p-2 will-change-transform animate-slide-up-fade"
			role="dialog"
